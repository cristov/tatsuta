...
!function() {
    ...
    qq.extend(this, {
        added: function(b) {
            var c = a.getUuid(b), d = a.getName(b), i = a.getSize(b), j = qq.status.SUBMITTING, k = e.push({
                id: b,
                name: d,
                originalName: d,
                uuid: c,
    ...
    qq.basePublicApi = {
        ...
        uploadStoredFiles: function() {
            ...
            if (0 === this._storedIds.length)
                ...
                for (; this._storedIds.length;)
                    a = this._storedIds.shift(), this._handler.upload(a)
        },
        ...
        _handleCheckedCallback: function(a) {
            ...
            }) : this._itemError("noFilesError") : (f = this._options.messages.tooManyItemsError.replace(/\{netItems\}/g, h).replace(/\{itemLimit\}/g, g), this._batchError(f))
            ...
            return h.then(function() {}, function() {
    ...
    s = "GET" === v.method || "DELETE" === v.method, qq.extend(this, {
    ...
    var l = qq.getUniqueId(), m = new qq.WindowReceiveMessage({
        log: g
    }), n = {}, o = {}, p = {}, q = this;
    qq.extend(a, {
    ...
    qq.uiPublicApi = {
        ...
        _addToList: function(a, b) {
            var c, d = 0;
            this._options.disableCancelForFormUploads&&!qq.supportedFeatures.ajaxUploading && this._templating.disableCancel(), this._options.display.prependFiles && (this._totalFilesInBatch > 1 && this._filesInBatchAddedToUi > 0 && (d = this._filesInBatchAddedToUi-1), c = {
                index : d
            }), this._options.multiple || (this._handler.cancelAll(), this._clearList()), this._templating.addFile(a, this._options.formatFileName(b), c), this._templating.generatePreview(a, this.getFile(a)), this._filesInBatchAddedToUi += 1, this._options.display.fileSizeOnSubmit && qq.supportedFeatures.ajaxUploading && this._displayFileSize(a)
        },
        _clearList: function() {
    ...
    function b() {
        ...
        if (y("Parsing template"), null == P.templateIdOrEl)
        ...
        if (b = qq.trimStr(b), d = document.createElement("div")
            , d.appendChild(qq.toElement(b)), P.button && (f = qq(d).getByClass(Q.button)[0], f && qq(f).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (i = qq(d).getByClass(Q.dropProcessing)[0], i && qq(i).remove()), g = qq(d).getByClass(Q.drop)[0], g&&!qq.DragAndDrop && (qq.log("DnD module unavailable.", "info"), qq(g).remove()), g&&!qq.supportedFeatures.fileDrop && qq(g).hasAttribute(M) && qq(g).css({
            display: "none"
        }), h = qq(d).getByClass(Q.thumbnail)[0], E ? h && (O = parseInt(h.getAttribute(K)), O = O > 0 ? O : null, F = qq(h).hasAttribute(L)) : h && qq(h).remove(), E = E && h, z = qq(d).getByClass(Q.editFilenameInput).length > 0, A = qq(d).getByClass(Q.retry).length > 0, c = qq(d).getByClass(Q.list)[0], null == c)throw new Error("Could not find the file list container in the template!");
    ...
    function t(a, b) {
        var c = i(a);
        c&&!qq(c).hasClass(Q.progressBar) && (c = qq(c).getByClass(Q.progressBar)[0]), c && qq(c).css({
            width: b + "%"
        })
    }
    function u() {
    ...
    var y, z, A, B, C, D, E, F, G, H, I = "qq-file-id", J = "qq-file-id-", K = "qq-max-size", L = "qq-server-scale", M = "qq-hide-dropzone", N=!1, O =- 1, P = {
        log: null,
    ...
    qq.extend(P, a), y = P.log, C = P.containerEl, E = void 0 !== P.imageGenerator, B = b(), u(), qq.extend(this, {
        render: function() {
        ...
        getFileId: function(a) {
            for (var b = a; null == b.getAttribute(I);)
                b = b.parentNode;
        ...
        generatePreview: function(a, b) {
            ...
            if (qq.supportedFeatures.imagePreviews) {
                if (R[a] = new qq.Promise, c)
                    return v(c), P.imageGenerator.generate(b, c, d).then(function() {
                    s(c), R[a].success()
                }, function() {
        ...
        updateThumbnail: function(a, b) {
            ...
            if (c) {
                if (b)
                    return P.imageGenerator.generate(b, c, d).then(function() {
                        s(c)
                    }, function() {
                        w(a, c)
                    });
    ...
    function e(a, b) {
        ...
        try {
            ...
            i("Error when attempting to parse form upload response (" + f.message + ")", "error"), c = {
                success: !1
            }
        }
        return c
    ...
    function f(b, c) {
        ...
        return d[a.uuidParam] = g[b].uuid, d[a.filenameParam] = h, j.initFormForUpload({
            method: e,
            endpoint: f,
            params: d,
    ...
    qq.extend(this, new qq.UploadHandlerFormApi(j, g, a.cors.expected, a.inputName, a.onCancel, c, i)), qq.extend(this, {
        upload: function(b) {
    ...
    function z(a, b) {
        var c;
        for (c = N.getTotalChunks(a)-1; c >= b; c -= 1)
    ...
    g = {
        ...
        onLeaveNotDescendants: function() {},
        onDrop: function() {}
    }, qq.extend(g, a), h = g.element, c(), f(), qq.extend(this, {
    ...
    qq.extend(d, a), c = new qq.AjaxRequester({
    ...
    return {
        ...
        getPolicy: function(a) {
            var b = {}, c = [], d = qq.s3.util.getBucket(a.endpoint), e = a.key, f = a.acl, g = a.type, h = new Date, i = a.expectedStatus, j = a.params, k = qq.s3.util.getSuccessRedirectAbsoluteUrl(a.successRedirectUrl), l = a.minFileSize, m = a.maxFileSize, n = a.reducedRedundancy;
        ...
        generateAwsParams: function(a, b) {
            var c = {}, d = a.params, e = new qq.Promise, f = qq.s3.util.getPolicy(a), g = a.type, h = a.key, i = a.accessKey, j = a.acl, k = a.expectedStatus, l = qq.s3.util.getSuccessRedirectAbsoluteUrl(a.successRedirectUrl), m = a.reducedRedundancy, n = a.log;
            return c.key = h, c.AWSAccessKeyId = i, g && (c["Content-Type"] = g), k && (c.success_action_status = k), l && (c.success_action_redirect = l), m && (c["x-amz-storage-class"] = "REDUCED_REDUNDANCY"), c.acl = j, qq.each(d, function(a, b) {
                var d = qq.s3.util.AWS_PARAM_PREFIX + a;
                c[d] = encodeURIComponent(b)
            }), b(f).then(function(a) {
                c.policy = a.policy, c.signature = a.signature, e.success(c)
            }, function(a) {
                a = a || "Can't continue further with request to S3 as we did not receive a valid signature and policy from the server.", n("Policy signing failed.  " + a, "error"), e.failure(a)
            }), e
        },
    ...
    qq.s3.FineUploaderBasic = function(a) {
    ...
    }, qq.extend(qq.s3.FineUploaderBasic.prototype, qq.basePublicApi), qq.extend(qq.s3.FineUploaderBasic.prototype, qq.basePrivateApi), qq.extend(qq.s3.FineUploaderBasic.prototype, {
        getKey: function(a) {
        ...
        _handleKeynameFunction: function(a, b, c, d) {
            ...
            g instanceof qq.Promise ? g.then(e, f) : null == g ? f() : e(g)
        },
        _onComplete: function(a, b, c, d) {
            ...
            return g && k ? (f = new qq.s3.UploadSuccessAjaxRequester({
                endpoint: k,
                customHeaders: l,
                cors: m,
                log: qq.bind(this.log, this)
            }), qq.extend(q, {
                key : j, uuid : n, name : b, bucket : o
            }, !0), e = qq.bind(function() {
        ...
        _onSubmitDelete: function(a, b) {
            var c = {
                key: this.getKey(a),
                bucket: qq.s3.util.getBucket(this._endpointStore.getEndpoint(a))
            };
            qq.FineUploaderBasic.prototype._onSubmitDelete.call(this, a, b, c)
        }
    })
}(), qq.s3.SignatureAjaxRequester = function(a) {
    "use strict";
    function b(a, b, c) {
        var d, e, h = b.responseText, i = f[a], j = i.expectingPolicy, k = i.promise;
        if (delete f[a], h)
            try {
                e = qq.parseJson(h)
        } catch (l) {
            g.log("Error attempting to parse signature response: " + l, "error")
        }
        e && e.invalid ? (c=!0, d = "Invalid policy document or request headers!") : e ? j&&!e.policy ? (c=!0, d = "Response does not include the base64 encoded policy!") : e.signature || (c=!0, d = "Response does not include the signature!") : (c=!0, d = "Received an empty or invalid response from the server!"), c ? (d && g.log(d, "error"), k.failure(d)) : k.success(e)
    }
    function c(a, b, c, d, f, g, h) {
        var i, j = "POST", k = [], l = "";
        switch (a) {
        case e.REQUEST_TYPE.MULTIPART_ABORT:
            j = "DELETE", i = qq.format("uploadId={}", g);
            break;
        case e.REQUEST_TYPE.MULTIPART_INITIATE:
            i = "uploads";
            break;
        case e.REQUEST_TYPE.MULTIPART_COMPLETE:
            i = qq.format("uploadId={}", g);
            break;
        case e.REQUEST_TYPE.MULTIPART_UPLOAD:
            j = "PUT", i = qq.format("partNumber={}&uploadId={}", h, g)
        }
        return i = c + "?" + i, qq.each(f, function(a) {
            k.push(a)
    ...
    qq.extend(g, a, !0), d = new qq.AjaxRequester({
        method: g.method,
        contentType: "application/json; charset=utf-8",
        endpointStore: {
            getEndpoint: function() {
                return g.signatureSpec.endpoint
            }
        },
        paramsStore: g.paramsStore,
        maxConnections: g.maxConnections,
        customHeaders: g.signatureSpec.customHeaders,
        log: g.log,
        onComplete: b,
        cors: g.cors,
        successfulResponseCodes: {
        ...
        getSignature: function(a, b) {
            ...
            return g.log("Submitting S3 signature request for " + a), d.initTransport(a).withParams(c).send(), f[a] = {
                promise: e,
                expectingPolicy: g.expectingPolicy
            }, e
        },
        constructStringToSign: function(a, b, d) {
            ...
            return {
                ...
                getToSign: function() {
                    h["x-amz-date"] = (new Date).toUTCString();
                    var i = c(a, b, d, f, h, e, g);
                    return {
                        headers: f ? qq.extend(h, {
                            "Content-Type": f
                        }): h,
                        endOfUrl: i.endOfUrl,
    ...
    "use strict";
    function b(a, b, c) {
        var f, g = d[a], h = b.responseText, i = {
            success: !0
        }, j = {
            success: !1
        };
    ...
    qq.extend(e, a), c = new qq.AjaxRequester({
        method: e.method,
        endpointStore: {
            getEndpoint: function() {
                return e.endpoint
    ...
    "use strict";
    function b(a) {
        var b, c = qq.s3.util.getBucket(g.endpointStore.getEndpoint(a)), d = {}, f = new qq.Promise, h = g.getKey(a);
        return d["x-amz-acl"] = g.acl, g.reducedRedundancy && (d["x-amz-storage-class"] = "REDUCED_REDUNDANCY"), d[qq.s3.util.AWS_PARAM_PREFIX + g.filenameParam] = encodeURIComponent(g.getName(a)), qq.each(g.paramsStore.getParams(a), function(a, b) {
            d[qq.s3.util.AWS_PARAM_PREFIX + a] = encodeURIComponent(b)
        }), b = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_INITIATE, c, h).withContentType(g.getContentType(a)).withHeaders(d).getToSign(), d = b.headers, e.getSignature(a, {
            headers: b.stringToSign
        }).then(function(a) {
            d.Authorization = "AWS " + g.accessKey + ":" + a.signature, f.success(d, b.endOfUrl)
        }, f.failure), f
    }
    function c(a, b, c) {
    ...
    qq.extend(g, a), e = new qq.s3.SignatureAjaxRequester({
        signatureSpec: g.signatureSpec,
        cors: g.cors,
        log: g.log
    }), d = new qq.AjaxRequester({
        method: g.method,
        contentType: null,
    ...
    "use strict";
    function b(a, b) {
        var c = {}, d = new qq.Promise, e = h.endpointStore.getEndpoint(a), g = qq.s3.util.getBucket(e), i = f.constructStringToSign(f.REQUEST_TYPE.MULTIPART_COMPLETE, g, h.getKey(a)).withUploadId(b).withContentType("application/xml; charset=UTF-8").getToSign();
        return c = i.headers, f.getSignature(a, {
            headers: i.stringToSign
        }).then(function(a) {
            c.Authorization = "AWS " + h.accessKey + ":" + a.signature, d.success(c, i.endOfUrl)
        }, d.failure), d
    }
    function c(a, b, c) {
        var d = g[a], e = new DOMParser, f = h.endpointStore.getEndpoint(a), i = qq.s3.util.getBucket(f), j = (h.getKey(a), e.parseFromString(b.responseText, "application/xml")), k = j.getElementsByTagName("Bucket"), l = j.getElementsByTagName("Key");
    ...
    qq.extend(h, a), f = new qq.s3.SignatureAjaxRequester({
        signatureSpec: h.signatureSpec,
        cors: h.cors,
        log: h.log
    }), e = new qq.AjaxRequester({
        method: h.method,
    ...
    "use strict";
    function b(a, b) {
        var c = {}, d = new qq.Promise, g = f.endpointStore.getEndpoint(a), h = qq.s3.util.getBucket(g), i = e.constructStringToSign(e.REQUEST_TYPE.MULTIPART_ABORT, h, f.getKey(a)).withUploadId(b).getToSign();
        return c = i.headers, e.getSignature(a, {
            headers: i.stringToSign
        }).then(function(a) {
            c.Authorization = "AWS " + f.accessKey + ":" + a.signature, d.success(c, i.endOfUrl)
        }, d.failure), d
    }
    function c(a, b, c) {
    ...
    qq.extend(f, a), e = new qq.s3.SignatureAjaxRequester({
    ...
    function e(b, c) {
        ...
        try {
            ...
            if (g.bucket === e && g.key === qq.s3.util.encodeQueryStringParam(k[b].key))
                return !0;
    ...
    function f(a) {
        var b = q.getParams(a);
        return b[p] = j.getName(a), qq.s3.util.generateAwsParams({
            endpoint: r.getEndpoint(a),
            params: b,
            key: k[a].key,
            accessKey: s,
            acl: t,
            minFileSize: v.minSizeLimit,
            maxFileSize: v.maxSizeLimit,
    ...
    function h(a) {
        var b = j.getName(a), c = z.createIframe(a), d = k[a].input;
        g(a, c).then(function(f) {
            n(a, b), f.appendChild(d), z.attachLoadEvent(c, function(d) {
    ...
    function i(c, d, e, f) {
        z.detachLoadEvent(c), qq(d).remove(), (f.success ||!a.onAutoRetry(c, e, f)) && (m(c, e, f), b(c))
    }
    var j = this, k = [], l = d, m = a.onComplete, n = a.onUpload, o = a.getKeyName, p = a.filenameParam, q = a.paramsStore, r = a.endpointStore, s = a.accessKey, t = a.objectProperties.acl, u = a.objectProperties.reducedRedundancy, v = a.validation, w = a.signature, x = a.iframeSupport.localBlankPagePath, y = new qq.s3.SignatureAjaxRequester({
        signatureSpec: w,
        cors: a.cors,
        log: l
    }), z = {};
    ...
    qq.extend(this, new qq.UploadHandlerFormApi(z, k, !1, "file", a.onCancel, c, l)), qq.extend(this, {
        upload: function(a) {
            var b = k[a].input, c = this.getName(a);
            if (!b)
                throw new Error("file with passed id was not added, or already uploaded or cancelled");
            this.isValid(a) && (k[a].key ? h(a) : o(a, c).then(function(b) {
                k[a].key = b, h(a)
            }))
        },
        getThirdPartyFileId: function(a) {
    ...
    function h(a) {
        var b = Y.getFile(a);
        H[a].type = b.type, X.createXhr(a), y(a) ? (void 0 === H[a].loaded && (H[a].loaded = 0), z(a)) : (H[a].loaded = 0, o(a))
    }
    function i(a) {
        var b = H[a].xhr;
        return function() {
            4 === b.readyState && (H[a].chunking.enabled ? G(a) : k(a))
        }
    }
    function j(a) {
    ...
    function k(c, e, f) {
        var g = f || H[c].xhr, h = Y.getName(c), i = Y.getSize(c), k = l(c, f), m = e || l(c), n = H[c].paused, o=!n && (null != e || k.success!==!0);
        o && j(k.code) && (d("This is an unrecoverable error, we must restart the upload entirely on the next retry attempt.", "error"), t(c), delete H[c].loaded, delete H[c].chunking), o && a.onAutoRetry(c, h, m, g) || (d(qq.format("Upload attempt for file ID {} to S3 is complete", c)), o || n || (m.success=!0, J(c, h, i, i), t(c), delete H[c].loaded, delete H[c].chunking), n ? qq.log(qq.format("Detected pause on {} ({}).", c, h)) : (K(c, h, m, g), H[c] && delete H[c].xhr, b(c)))
    }
    function l(a, b) {
        var c, e = b || H[a].xhr, f = {};
        try {
            d(qq.format("Received response status {} with body: {}", e.status, e.responseText)), e.status === I ? f.success=!0 : (c = m(e.responseText), c && (f.error = c.message, f.code = c.code))
        } catch (g) {
    ...
    function n(a) {
        var b = Y.getName(a);
        Y.isValid(a) && (r(a), void 0 !== f(a) ? (L(a, b), h(a)) : M(a, b).then(function(c) {
            g(a, c), L(a, b), h(a)
        }))
    }
    function o(a) {
        var b = H[a].xhr, c = Y.getName(a), e = Y.getFile(a);
        b.upload.onprogress = function(b) {
            b.lengthComputable && (H[a].loaded = b.loaded, J(a, c, b.loaded, b.total))
    ...
    function p(a) {
        var b = O.getParams(a);
        return b[N] = Y.getName(a), qq.s3.util.generateAwsParams({
            endpoint: P.getEndpoint(a),
            params: b,
            type: H[a].type,
            key: f(a),
            accessKey: Q,
            ...
            reducedRedundancy: S,
            log: d
        }, qq.bind(Z.getSignature, this, a))
    }
    function q(a, b) {
        var c = new FormData, d = P.getEndpoint(a), e = d, f = H[a].xhr, g = new qq.Promise;
    ...
    function r(a) {
        var b, c;
        W && void 0 === f(a) && (b = x(a), c = localStorage.getItem(b), c && (d(qq.format("Identified file with ID {} and name of {} as resumable.", a, Y.getName(a))), c = JSON.parse(c), H[a].uuid = c.uuid, g(a, c.key), H[a].loaded = c.loaded, H[a].chunking = c.chunking))
    }
    function s(a) {
        var b, c;
        W && (b = x(a), c = {
            name : Y.getName(a), size: Y.getSize(a), uuid: Y.getUuid(a), key: f(a), loaded: H[a].loaded, chunking: H[a].chunking, lastUpdated: Date.now()
        }, localStorage.setItem(b, JSON.stringify(c)))
    }
    function t(a) {
        var b;
        return W && (b = x(a), b && localStorage.getItem(b)) ? (localStorage.removeItem(b), !0) : !1
    }
    function u(a) {
        W && qq.each(localStorage, function(b, c) {
    ...
    function x(b) {
        var c = Y.getName(b), d = Y.getSize(b), e = a.chunking.partSize, f = a.endpointStore.getEndpoint(b), g = qq.s3.util.getBucket(f);
        return qq.format("qqs3resume-{}-{}-{}-{}", c, d, e, g)
    }
    function y(a) {
        var b;
        return H[a].chunking || (H[a].chunking = {}, b = X.getTotalChunks(a), b > 1 ? (H[a].chunking.enabled=!0, H[a].chunking.parts = b) : H[a].chunking.enabled=!1), H[a].chunking.enabled
    }
    function z(a) {
        F(a).then(function() {
            B(a)
    ...
    function A(a) {
        return H[a].chunking.lastSent >= 0 ? H[a].chunking.lastSent + 1 : 0
    }
    function B(a) {
        var b = H[a].chunking.parts, c = A(a);
        b > c ? D(a) : C(a)
    }
    function C(a) {
        var b = H[a].chunking.uploadId, c = H[a].chunking.etags;
        ab.send(a, b, c).then(function(b) {
            k(a, null, b)
        }, function(b, c) {
            k(a, {
                error: b
    ...
    function D(b) {
        var c = A(b), e = Y.getName(b), f = H[b].xhr, g = Y.getSize(b), h = X.getChunkData(b, c), j = a.endpointStore.getEndpoint(b);
        E(b).then(function(c, k) {
            var l = j + "/" + k;
            a.onUploadChunk(b, e, X.getChunkDataForCallback(h)), f.upload.onprogress = function(c) {
                if (c.lengthComputable) {
                    var d = c.loaded + H[b].loaded;
                    a.onProgress(b, e, d, g)
                }
            }, f.onreadystatechange = i(b), f.open("PUT", l, !0), qq.each(c, function(a, b) {
                f.setRequestHeader(a, b)
            }), d(qq.format("Sending part {} of {} for file ID {} - {} ({} bytes)", h.part + 1, h.count, b, e, h.size)), f.send(h.blob)
        }, function() {
            k(b, {
    ...
    function E(b) {
        var c = {}, d = a.endpointStore.getEndpoint(b), f = qq.s3.util.getBucket(d), g = e(b), h = new qq.Promise, i = $.constructStringToSign($.REQUEST_TYPE.MULTIPART_UPLOAD, f, g).withPartNum(A(b) + 1).withUploadId(H[b].chunking.uploadId).getToSign();
        return c = i.headers, $.getSignature(b, {
            headers: i.stringToSign
        }).then(function(b) {
            c.Authorization = "AWS " + a.accessKey + ":" + b.signature, h.success(c, i.endOfUrl)
        }, h.failure), h
    }
    function F(a) {
        return H[a].chunking.uploadId ? (new qq.Promise).success(H[a].chunking.uploadId) : _.send(a).then(function(b) {
            H[a].chunking.uploadId = b
        })
    }
    function G(b) {
        var c, e = A(b), f = H[b].xhr, g = l(b), h = X.getChunkData(b, e);
        g.success ? (H[b].chunking.lastSent = e, c = f.getResponseHeader("ETag"), H[b].chunking.etags || (H[b].chunking.etags = []), H[b].chunking.etags.push({
            part : e + 1, etag: c
        }), H[b].loaded += h.size, s(b), a.onUploadChunkSuccess(b, h, g, f), B(b)) : (g.error && d(g.error, "error"), k(b))
    }
    var H = [], I = 200, J = a.onProgress, K = a.onComplete, L = a.onUpload, M = a.getKeyName, N = a.filenameParam, O = a.paramsStore, P = a.endpointStore, Q = a.accessKey, R = a.objectProperties.acl, S = a.objectProperties.reducedRedundancy, T = a.validation, U = a.signature, V = a.chunking.enabled && qq.supportedFeatures.chunking, W = a.resume.enabled && V && qq.supportedFeatures.resume && void 0 !== window.localStorage, X = {}, Y = this, Z = new qq.s3.SignatureAjaxRequester({
        expectingPolicy: !0,
        signatureSpec: U,
        cors: a.cors,
        log: d
    }), $ = new qq.s3.SignatureAjaxRequester({
        signatureSpec: U,
        cors: a.cors,
        log: d
    }), _ = new qq.s3.InitiateMultipartAjaxRequester({
        filenameParam: N,
        endpointStore: P,
        paramsStore: O,
        signatureSpec: U,
    ...
    }), ab = new qq.s3.CompleteMultipartAjaxRequester({
        endpointStore: P,
        signatureSpec: U,
        accessKey: a.accessKey,
        cors: a.cors,
    ...
    }), bb = new qq.s3.AbortMultipartAjaxRequester({
        endpointStore: P,
        signatureSpec: U,
        accessKey: a.accessKey,
        cors: a.cors,
    ...
    qq.extend(this, new qq.UploadHandlerXhrApi(X, H, V ? a.chunking : null, n, a.onCancel, c, d)), w(), qq.override(this, function(a) {
        return {
            add: function(b) {
                var c = a.add(b);
                return W && r(c), c
            ...
            expunge: function(b) {
                var c = H[b].chunking && H[b].chunking.uploadId, d = t(b);
                void 0 !== c && d && bb.send(b, c), a.expunge(b)
            },
            getThirdPartyFileId: function(a) {
                return f(a)
            }
